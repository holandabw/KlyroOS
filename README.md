...
Você acaba de instalar o KlyroOS. Em alguns minutos, sua empresa vai
...
```
Clona o https://github.com/holandabw/KlyroOS.git na pasta atual,
...
```
git clone https://github.com/holandabw/KlyroOS.git
cd KlyroOS
code .
```
...
Quando o `/instalar` terminar, renomeia a pasta `KlyroOS/` pro nome do teu
negócio (fecha o VS Code, renomeia no Explorer/Finder, abre de novo). A
pasta não fica como "KlyroOS" — ela é o teu negócio agora.
...
closed loop dentro do KlyroOS (decide → executa → captura → realimenta →
ajusta sozinho).
...
KlyroOS é a versão da [Klyro Labs](https://klyrolabs.site) do MazyOS,
criado por [mazzeoia.com.br](https://mazzeoia.com.br) —
[github.com/mazzeoia/MazyOS](https://github.com/mazzeoia/MazyOS).
